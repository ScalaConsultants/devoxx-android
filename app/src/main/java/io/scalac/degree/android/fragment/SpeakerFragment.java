...
public class SpeakerFragment extends BaseFragment implements
	...
	@FragmentArg TalkSpeakerApiModel speaker;
	@FragmentArg SpeakerShortApiModel speakerShortApiModel;
	...
	@Bean SpeakerDataManager speakerDataManager;
	...
	@Override public void onDataAvailable(SpeakerFullApiModel speakerFullApiModel) {
	...
	@Override public void onDataAvailable(List<SpeakerFullApiModel> items) {
